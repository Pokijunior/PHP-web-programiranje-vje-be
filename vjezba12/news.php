<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			setcookie("news_link_1", "index.php?menu=" . $menu . "&action=1", time() + 86400, "/");
			print '
			...
			setcookie("news_link_2", "index.php?menu=" . $menu . "&action=2", time() + 86400, "/");
			print '
			...
			setcookie("news_link_3", "index.php?menu=" . $menu . "&action=3", time() + 86400, "/");
			print '
